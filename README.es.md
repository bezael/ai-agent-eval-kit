...
```
--path PATH    Ruta a un archivo de evals concreto (default: evals/canonical/evals.json)
--all          Ejecuta todos los evals de todas las carpetas en evals/
--model MODEL  Modelo a evaluar (default: claude-sonnet-4-6)
--save         Guarda los resultados en un CSV
```
...
→ [Suscríbete gratis y descarga el PDF](https://dominicode.com/newsletter?source=repo_ai-agent-eval-kit&topic=ai-agent)
